    ...
    <div id="about" className="relative p-4 mb-4">
      ...
      <div className="relative justify-center items-center">
        <p className="font-medium text-base text-center mt-20  text-bluePText">
          <b>Meshrak Real Estate</b> is a premier real estate company located in
          Addis Ababa, Ethiopia, offers luxurious and modern properties designed
          for <br /> sophisticated urban living. Our homes combine contemporary
          architecture with high-quality finishes, providing comfort and style.{' '}
          <br /> Experience the best of city life with Meshrak Real Estate’s
          premier residential offerings
        </p>
      </div>

      <div className="flex flex-col sm:flex-row justify-center items-center mt-[50px] ml-[28px]">
        <div className="bg-blue-100 py-35 px-10 h-[160px] w-[350px] mr-[30px] flex flex-col justify-center items-center rounded-[10px] shadow-md mb-5 dark:bg-slate-700 hover:bg-blue-200 hover:shadow-lg transition duration-300">
          <p className="font-medium text-3xl leading-[50px] text-blueCardTitle capitalize dark:text-gray-100 hover:text-blue-700 transition duration-300">
            {cardTitle1}
          </p>
          <p className="text-md leading-8 text-center text-blueCardSubTitle dark:text-white">
            {cardSubText1}
          </p>
        </div>
        <div className="bg-blue-100 py-35 px-10 h-[160px] w-[350px] mr-[30px] flex flex-col justify-center items-center rounded-[10px] shadow-md mb-5 dark:bg-slate-700 hover:bg-blue-200 hover:shadow-lg transition duration-300">
